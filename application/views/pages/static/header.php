      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url(); ?>tabelpertanyaan"><i class="fa fa-circle-o"></i>Tabel Pertanyaan</a></li>
            <li><a href="<?php echo base_url(); ?>tabelrule"><i class="fa fa-circle-o"></i>Tabel Rule</a></li>
            <li><a href="<?php echo base_url(); ?>tabelpenyakit"><i class="fa fa-circle-o"></i>Tabel Penyakit</a></li>
            <li><a href="<?php echo base_url(); ?>tabelgejala"><i class="fa fa-circle-o"></i>Tabel Gejala</a></li>
          </ul>
        </li>
  ...
  <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <center>  <h2 class="modal-title" id="exampleModalLabel">LOGIN</h2></center>
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input type="password" class="form-control" id="message-text" name="password" required></input>
            </div>
        </div>
